...
document.addEventListener("DOMContentLoaded", function () {
    fetch("data.json")
        ...
        .then(data => {
            ...
            // Carousel navigation logic for #propertyCarousel only
            const propertyCarousel = document.querySelector('#propertyCarousel');
            const prevButton = propertyCarousel.querySelector('.carousel-control-prev');
            const nextButton = propertyCarousel.querySelector('.carousel-control-next');
            const totalItems = propertyCarousel.querySelectorAll('.carousel-item').length;
            ...
            propertyCarousel.addEventListener('slid.bs.carousel', function () {
                const activeIndex = Array.from(propertyCarousel.querySelectorAll('.carousel-item'))
                    .indexOf(propertyCarousel.querySelector('.carousel-item.active'));
